...
export const styles = {
  ...
  // =========================================================================
  // ESTILOS DE GESTIÓN DINÁMICA DE HOJAS OPCIONALES (ADMISIÓN)
  // =========================================================================
  admisionInfoBanner: {
    display: 'flex',
    alignItems: 'flex-start',
  ...
  sheetCard: (isEnabled) => ({
    ...
    borderRadius: 2,
    border: '1.5px solid',
    borderColor: isEnabled ? '#1DC2A0' : '#E2E8F0',
    ...
    flexDirection: 'column',
    justifyContent: 'space-between',
    boxShadow: isEnabled ? '0 2px 8px rgba(29, 194, 160, 0.08)' : 'none',
  }),
  sheetHeader: {
    display: 'flex',
    alignItems: 'flex-start',
  ...
  sheetTitle: (isEnabled) => ({
    fontWeight: 700,
    fontSize: '13px',
    color: isEnabled ? '#1E2875' : '#64748B',
    display: 'flex',
    alignItems: 'center',
    gap: 0.75,
    fontFamily: "'Inter', sans-serif",
  ...
  sheetToggleBtn: (isEnabled) => ({
    ...
    py: 0.3,
    minHeight: '24px',
    bgcolor: isEnabled ? '#E6F9F5' : '#F1F5F9',
    color: isEnabled ? '#0D9488' : '#64748B',
    border: '1px solid',
    borderColor: isEnabled ? '#1DC2A0' : '#CBD5E1',
    '&:hover': {
      bgcolor: isEnabled ? '#CCFBF1' : '#E2E8F0',
    },
  }),
