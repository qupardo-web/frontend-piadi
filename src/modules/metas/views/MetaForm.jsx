        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, mb: 4 }}>
          ...
          <Box sx={styles.breadcrumb}>
            ...
            <Typography variant="body1" sx={styles.breadcrumbCurrent}>
              {modo === 'crear' ? 'Nueva Meta' : 'Editar Meta'}
            </Typography>
          </Box>
          ...
          <Box sx={styles.pageHeader}>
            ...
            {/* Mode Switcher Group */}
            <Box sx={styles.modoSwitch} role="group" aria-label="Modo del formulario">
              <Box 
                component="button" 
                onClick={() => setModo('crear')}
                sx={styles.modoSwitchBtn(modo === 'crear')}
              >
                Nueva meta
              </Box>
              <Box 
                ...
                sx={styles.modoSwitchBtn(modo === 'editar')}
              >
                Editar meta
              </Box>
            </Box>
